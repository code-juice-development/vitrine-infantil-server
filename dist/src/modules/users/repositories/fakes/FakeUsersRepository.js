...
var FakeUsersRepository = /** @class */ (function () {
    ...
    FakeUsersRepository.prototype.update = function (_a) {
        var id = _a.id, email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_b) {
                user = this.users.find(function (user) { return user.id === id; });
                Object.assign(user, { id: id, email: email, password: password });
                return [2 /*return*/, user !== null && user !== void 0 ? user : new User_1.default()];
            });
        });
    };
    FakeUsersRepository.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var findIndex;
            return __generator(this, function (_a) {
                findIndex = this.users.findIndex(function (userFind) { return userFind.id === id; });
    ...
    FakeUsersRepository.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
