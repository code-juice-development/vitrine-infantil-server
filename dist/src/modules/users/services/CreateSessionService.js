...
var CreateSessionService = /** @class */ (function () {
    function CreateSessionService(usersRepository, hashProvider, tokenProvider) {
    ...
    CreateSessionService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, isPasswordMatch, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default('Email e/ou Senha incorreto', 401);
                        }
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.tokenProvider.generateToken(user.id)];
                    case 3:
                        token = _b.sent();
                        return [2 /*return*/, {
                                user: user,
