...
var ListUserService_1 = __importDefault(require("@modules/users/services/ListUserService"));
...
var DeleteUserService_1 = __importDefault(require("@modules/users/services/DeleteUserService"));
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listUserService = tsyringe_1.container.resolve(ListUserService_1.default);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, showUserService.execute({ id: id })];
                    case 1:
                        user = _a.sent();
                        delete user.password;
    ...
    UsersController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, email, password, updateUserService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = request.params.id;
