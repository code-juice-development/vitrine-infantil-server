...
describe('List Products Service', function () {
    beforeEach(function () {
        fakeProductsRepository = new FakeProductsRepository_1.default();
        listProductsService = new ListProductsService_1.default(fakeProductsRepository);
    });
    it('should be able to list all Products', function () { return __awaiter(void 0, void 0, void 0, function () {
        var productYellowShoe, productRedShoe, products;
