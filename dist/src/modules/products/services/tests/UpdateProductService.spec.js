...
describe('Update Product Service', function () {
    beforeEach(function () {
        fakeProductsRepository = new FakeProductsRepository_1.default();
        updateProductService = new UpdateProductService_1.default(fakeProductsRepository);
    });
    it('should be able to list update a Product', function () { return __awaiter(void 0, void 0, void 0, function () {
