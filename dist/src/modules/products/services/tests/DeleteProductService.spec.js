...
describe('Delete Product Service', function () {
    beforeEach(function () {
        ...
        deleteProductService = new DeleteProductService_1.default(fakeProductsRepository);
    });
    it('should be able to delete a Product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var product, id, findedProduct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, fakeProductsRepository.findById(id)];
                case 3:
