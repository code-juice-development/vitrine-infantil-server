...
describe('Show Product Service', function () {
    beforeEach(function () {
        fakeProductsRepository = new FakeProductsRepository_1.default();
        showProductService = new ShowProductService_1.default(fakeProductsRepository);
    });
    it('should be able to show a Product', function () { return __awaiter(void 0, void 0, void 0, function () {
        var product, findedProduct;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    product = _a.sent();
                    return [4 /*yield*/, showProductService.execute({ id: product.id })];
                case 2:
                    findedProduct = _a.sent();
                    expect(findedProduct).toEqual(product);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should not be able to show a nonexistent Product', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
